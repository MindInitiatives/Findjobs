							...
							<form action="search.html" className="serach-form-area">
								<div className="row justify-content-center form-wrap">
									<div className="col-lg-6 form-cols form-icon-prepend">
										<input type="text" className="form-control search" name="search" placeholder="what are you looging for?" onChange={(e) => onChangeSearchTitle(e)}/>
                                    ...
                                    <div className="col-lg-4 form-cols form-icon-prepend">
										<input type="text" className="form-control" name="location" placeholder="what are you looging for?" onChange={(e) => onChangeSearchTitle(e)}/>
										<div className="svg-icon">
